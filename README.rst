...
.. note::
    ...
    If you’re viewing this on GitHub, then the generated HTML at
    https://jnrowe.github.io/river-configs/ will be a better experience.

My configuration is generated by extracting the code blocks from within this
file.  It looks *far* more complicated than it needs to be because it fits in to
