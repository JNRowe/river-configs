...
.. note::
    ...
    Media and function keys perform tasks that should work across regardless of
    lock state.
...
.. note::
    ...
    This reflects what is at this point my *decades* old tradition of defaulting
    to fullscreen on even tags.  It doesn’t really make sense, but I’m quite
    accustomed to it.
...
.. note::
    ...
    default applications without all the bar flashes that would result.
